	...
	function __construct() {
		...
		$this->profiles = array(
			'dribbble' => array(
				...
				'pattern' => '<li class="social-dribbble"><a title="新浪微博" href="%s" %s>新浪微博</a></li>',
			),
			'email' => array(
			...
			'facebook' => array(
				...
				'pattern' => '<li class="social-facebook"><a title="知乎" href="%s" %s>知乎</a></li>',
			),
			'gplus' => array(
			...
			'lastfm' => array(
				'label'	  => __( 'Github', 'mythemeshop' ),
				'pattern' => '<li class="social-lastfm"><a title="Github" href="%s" %s>Github</a></li>',
			),
			'tumblr' => array(
			...
			'vimeo' => array(
				'label'	  => __( '开源中国Git', 'mythemeshop' ),
				'pattern' => '<li class="social-vimeo"><a title="开源中国Git" href="%s" %s>开源中国Git</a></li>',
			),
		);
