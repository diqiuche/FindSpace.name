...
<!-- start underAchives google Ads-->
<?php if ($i==2) {?>
<div id="underArchives" class="pexcerpt0 post excerpt ">
<a href="http://www.findspace.name">
<div class="featured-thumbnail">
<img src="http://www.findspace.name/wp-content/uploads/2015/06/Google-620x315-220x162.jpg" />
</div> 
</a>
<style> 
.abc{height: 370px;width: 160px} 
</style> 

<div class="post-content" class="abc post-content image-caption-format-1 ">
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- UnderArchives2 -->
<ins class="adsbygoogle"
     style="display:inline-block;width:370px;height:160px"
     data-ad-client="ca-pub-8527554614606787"
     data-ad-slot="5451951957"></ins>
<script>
...
<!-- end underAchives google Ads-->
				...
				<article class="<?php echo 'pexcerpt'.$i++?> post excerpt <?php echo (++$j % 2 == 0) ? 'last' : ''; ?>">
					...
					<header>						
						...
						<div class="post-info"><span class="theauthor"><?php the_views(); ?></span> | <span class="thetime"><?php the_time( get_option( 'date_format' ) ); ?></span></div>
